<template>
  <div>
    ...
    />
    <form>
      <input v-model="taskName" type="text" class="search" placeholder="Add Tasks" />
      <button   @click.prevent="createNewTaskStart()" type="submit"><i class="fa fa-plus btn"></i></button>
...
export default {
  ...
  methods:{
    ...
    createNewTaskStart: function(){ //This function adds user-input into action that will be added to .store
      let payload = { 
